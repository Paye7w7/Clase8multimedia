...
function start() {
    ...
    function placar() {
        $("#placar").html("<h2> Puntos: " + pontos + "<br>" + " Bolivianos salvados: " + salvos + "<br>" + " Bolivianos Muertos: " + perdidos + "</h2>");
    }
    ...
    function gameOver() {
        ...
        $("#fim").html("<h1> Game Over </h1><p>Tu puntuación es: " + pontos + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><button>Jugar de Nuevo</button></div>");
    }
